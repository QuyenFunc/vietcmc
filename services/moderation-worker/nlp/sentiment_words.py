...
# ==================== TỪ TIÊU CỰC (NEGATIVE) - KHÔNG TOXIC ====================

# Tiêu cực mức độ cao (nhưng không toxic)
HIGHLY_NEGATIVE = [
    # Chất lượng kém
...
# Trong khoảng [-5, 5] là neutral

# ==================== INTENSIFIERS (Từ nhấn mạnh) ====================
